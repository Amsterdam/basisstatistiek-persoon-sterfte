...
De aard van de statistiek maakt dat er geen stand voor gezet kan worden.
...
#. Verwerk alle sterftegegevens uit de mutatieberichten. `verwerk_sterfte.sql <https://git.datapunt.amsterdam.nl/Basisstatistiek/database/raw/8bc15cb1a0f74e3da207781d107069c7e957d0f0/persoon/transformaties/sql/verwerk_sterfte.sql>`_
...
#. Maak de volgende procedure zoals beschreven in `functie_aangehaakt.sql <https://git.datapunt.amsterdam.nl/Basisstatistiek/persoon-sterfte/raw/ec7c7d18801caaa87a38df45ee16a272a23b0901/technisch/syntax/functie_aangehaakt.sql>`_. Draai vervolgens de syntax wat onder *stap 2* staat beschreven om gegevens aan de kern aan te haken in `query.sql <https://git.datapunt.amsterdam.nl/Basisstatistiek/persoon-sterfte/raw/e3f9a9783ae6c14dd58b98fc32b785bb0e619516/technisch/syntax/query.sql>`_
...
#. Draai de volgende syntax op de database. `sas.sql <https://git.datapunt.amsterdam.nl/Basisstatistiek/persoon-sterfte/raw/265d48a0512f06fe77986b930dcd4bcfe1ac261e/technisch/syntax/sas.sql>`_
#. Exporteer het resultaat van de aangemaakte SAS view (sterfte_aangehaakt_sas) naar een CSV bestand (dit doe je door alles te selecteren uit de view en vervolgens naar file-export te gaan en het bestand op te slaan als CSV).
#. Draai de volgende syntax in SAS en verander waar nodig de bestandsnaam van het CSV bestand en de naam en locatie van het SAS bestand. `aanmaken_sas_bestand.sas <https://git.datapunt.amsterdam.nl/Basisstatistiek/persoon-sterfte/raw/52d546530d39c8d765c7152da09c81ba41e1e84b/technisch/syntax/aanmaken_sas_bestand.sas>`_
